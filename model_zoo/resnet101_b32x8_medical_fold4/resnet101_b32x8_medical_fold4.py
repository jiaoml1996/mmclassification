...
data = dict(
    ...
    train=dict(
        ...
        ann_file=
        '/mnt/lustre/jiaomenglei/code/medical_by/data/data_all/数据重新整理/训练索引/mri_矢状位/fold_4/train.json',
        pipeline=[
            dict(type='LoadImageFromFile', mode='train'),
            dict(type='Resize', size=(224, 224)),
            dict(type='RandomFlip', flip_prob=0.5, direction='horizontal'),
    ...
    val=dict(
        ...
        '/mnt/lustre/jiaomenglei/code/medical_by/data/data_all/数据重新整理',
        ann_file=
        '/mnt/lustre/jiaomenglei/code/medical_by/data/data_all/数据重新整理/训练索引/mri_矢状位/fold_4/test.json',
        pipeline=[
            dict(type='LoadImageFromFile', mode='val'),
            dict(type='Resize', size=(224, 224)),
            dict(type='ImageToTensor', keys=['img']),
...
work_dir = './work_dirs/resnet101_b32x8_medical_fold4'
gpu_ids = range(0, 8)